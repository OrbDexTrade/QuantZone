...
class PerpMarketMaker:
    ...
    def __init__(self, loop: asyncio.AbstractEventLoop, 
        ...
        self.market_connector = _get_connector('orbdex_perp', loop=self.loop)

        self.pricer = PricerClass(self)

        self.algo_name = f"PARABOT_MM_{os.getenv('ORBDEX_ID', 'default')}".upper()
    ...
    def start(self) -> None:
        ...
        self._params_manager.publish(Param("algo_env", os.getenv("ORBDEX_ENVIRONMENT", "unknown")))
