...
RUN groupadd -g 1000 orbdexbot && \
    useradd -m -s /bin/bash --uid 1000 -g 1000 orbdexbot && \
    chown -R orbdexbot:orbdexbot /app

USER orbdexbot:orbdexbot

# Install Rust toolchain
RUN curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- -y
ENV PATH="/home/orbdexbot/.cargo/bin:${PATH}"
