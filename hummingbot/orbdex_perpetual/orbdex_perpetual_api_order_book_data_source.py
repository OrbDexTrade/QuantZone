...
import hummingbot.connector.derivative.orbdex_perpetual.orbdex_perpetual_constants as CONSTANTS
import hummingbot.connector.derivative.orbdex_perpetual.orbdex_perpetual_web_utils as web_utils
...
if TYPE_CHECKING:
    from hummingbot.connector.derivative.orbdex_perpetual.orbdex_perpetual_derivative import (
        OrbDexPerpetualDerivative,
    )


class OrbDexPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    ...
    def __init__(
            ...
            connector: 'OrbDexPerpetualDerivative',
    ...
    def _next_funding_time(self) -> int:
        """
        Funding premium is updated every 5 seconds as mentioned in https://docs.orbdex.trade/risk-system/funding-mechanism
        """
        return time.time() + 5
