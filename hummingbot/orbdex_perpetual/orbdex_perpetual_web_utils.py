...
class OrbDexPerpetualRESTPostProcessor(RESTPostProcessorBase):
...
class OrbDexPerpetualRESTPreProcessor(RESTPreProcessorBase):
...
def build_api_factory(
    ...
    api_factory = WebAssistantsFactory(
        throttler=throttler,
        rest_pre_processors=[OrbDexPerpetualRESTPreProcessor()],
        rest_post_processors=[OrbDexPerpetualRESTPostProcessor()],
        auth=auth)
    return api_factory
