...
class OrbDexPerpetualUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        extra_headers = {
            "Authorization": f"Bearer {self._auth.orbdex_account.jwt_token}"
        }
        ...
        auth_payload = {
            ...
            "jsonrpc": "2.0",
            "method": "auth",
            "params": {"bearer": self._auth.orbdex_account.jwt_token}
        }
