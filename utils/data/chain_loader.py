...
from orbdex_py.api.models import SystemConfig
...
class DataConfig:
    ...
    base_dir: Path = Path("data/orbdex/chain")
    _full_node_client: FullNodeClient = None
    orbdex_system_config: SystemConfig = None
    ...
    def full_node_client(self) -> FullNodeClient:
        if self._full_node_client is None:
            ...
            self.orbdex_system_config = config
        return self._full_node_client
    
    def load_contracts(self) -> None:
        paraclear_address = self.orbdex_system_config.paraclear_address
        ...
        usdc_address = self.orbdex_system_config.bridged_tokens[0].l2_token_address
        ...
        oracle_address = self.orbdex_system_config.oracle_address
